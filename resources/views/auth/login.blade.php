                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain">
                                    ...
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                            <input type="email" name="email" class="form-control form-control-lg"
                                                value="{{ old('email') ?? 'admin@admin.com' }}" aria-label="Email">
                                            @error('email')
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-1 text-sm mx-auto">
                                        Esqueceu a senha? Redefina sua senha
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url({{ asset('/img/lab-background.jpg') }});
              background-size: cover;">
                                <span class="mask bg-gradient-primary opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Laborclínica Thonson"</h4>
                                <p class="text-white position-relative">Serenidade e compromisso com sua saúde</p>
                            </div>
                        </div>
                    </div>
                </div>
