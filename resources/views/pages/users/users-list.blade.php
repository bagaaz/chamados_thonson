...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Gerenciamento de Usuários'])

    <div class="row mt-4 mx-4">
        <div class="card mb-4">
            <div class="row card-header pb-0">
                <div class="col-4 col-md-2">
                    <a href="{{ route('users.create') }}" class="btn btn-icon btn-3 btn-primary w-100 mb-0">
                ...
                <div class="col-4 col-md-2">
                    <button onclick="verificaParametroId('{{ route('users.edit', ['user' => 'param_id']) }}')"
                ...
                <div class="col-4 col-md-2">
                    <button onclick="verificaParametroId('{{ route('users.destroy', ['user' => 'param_id']) }}')"
                ...
                <div class="col-12 col-md-6 mt-3 mt-md-0">
                    <form action="{{ route('users') }}" method="GET" class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Pesquise um usuário..."
                                aria-label="Pesquise um usuário..." aria-describedby="button-addon2">
