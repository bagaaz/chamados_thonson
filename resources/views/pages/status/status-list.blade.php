...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Status'])

    <div class="row mt-4 mx-4">
        <div class="card mb-4">
            <div class="row card-header pb-0">
                <div class="col-4 col-md-2">
                    <a href="{{ route('status.create') }}" class="btn btn-icon btn-3 btn-primary w-100 mb-0">
                ...
                <div class="col-4 col-md-2">
                    <button onclick="verificaParametroId('{{ route('status.edit', ['status' => 'param_id']) }}')"
                ...
                <div class="col-4 col-md-2">
                    <button onclick="verificaParametroId('{{ route('status.destroy', ['status' => 'param_id']) }}')"
                ...
                <div class="col-12 col-md-6 mt-3 mt-md-0">
                    <form action="{{ route('status') }}" method="GET" class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Pesquise um status..."
                                aria-label="Pesquise um status..." aria-describedby="button-addon2">
                                ...
                                <tr>
                                    <td style="width: .2rem">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="{{ $statusItem['id'] }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex px-3 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">{{ $statusItem['name'] }}</h6>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
